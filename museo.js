...
Museo.PromptModule = function() {
	return {
		...
		registerHash: function(mode, text) {},
		generatedByDiv: {
			artist: '<div id="generatedBy"><p>Generate by: <span class="artist">Artist</span> <a href="JavaScript:void(0)" class="tags">Tags</a> <a href="JavaScript:void(0)" class="username">Username</a></p></div>',
			tags: '<div id="generatedBy"><p>Generate by: <a href="JavaScript:void(0)" class="artist">Artist</a> <span class="tags">Tags</span> <a href="JavaScript:void(0)" class="username">Username</a></p></div>',
			username: '<div id="generatedBy"><p>Generate by: <a href="JavaScript:void(0)" class="artist">Artist</a> <a href="JavaScript:void(0)" class="tags">Tags</a> <span class="username">Username</span></p></div>'
		},
		calloutDiv: {
	  ...
	  <div id="artist">\
		...
		<ol>\
		<li class="artist1"><a href="JavaScript:void(0)"><img src="http://userserve-ak.last.fm/serve/252/269753.jpg" alt="Click to play artists similar to Muse." width="200" height="140" /><br />Muse</a></li>\
		<li class="artist2"><a href="JavaScript:void(0)"><img src="http://userserve-ak.last.fm/serve/252/61574.jpg" alt="Click to play artists similar to The Beatles." width="200" height="140" /><br />The Beatles</a></li>\
		<li class="artist3"><a href="JavaScript:void(0)"><img src="http://userserve-ak.last.fm/serve/252/82971.jpg" alt="Click to play artists similar to Radiohead." width="200" height="140" /><br />Radiohead</a></li>\
		<li class="artist4"><a href="JavaScript:void(0)"><img src="http://userserve-ak.last.fm/serve/252/39971359.png" alt="Click to play artists similar to Lady Gaga." width="200" height="140" /><br />Lady Gaga</a></li>\
		<li class="artist5"><a href="JavaScript:void(0)"><img src="http://userserve-ak.last.fm/serve/252/17666215.jpg" alt="Click to play artists similar to Coldplay." width="200" height="140" /><br />Coldplay</a></li>\
		<li class="artist6"><a href="JavaScript:void(0)"><img src="http://userserve-ak.last.fm/serve/252/3404895.jpg" alt="Click to play artists similar to Red Hot Chili Peppers." width="200" height="140" /><br />Red Hot Chili Peppers</a></li>\
		</ol>\
	  </div>',
			tags: '\
	  <div id="tags">\
		<h2>Popular Tags:</h2>\
		<ul>\
		  <li><a href="JavaScript:void(0)">acoustic</a>,</li>\
		  <li><a href="JavaScript:void(0)">ambient</a>,</li>\
		  <li><a href="JavaScript:void(0)">blues</a>,</li>\
		  <li><a href="JavaScript:void(0)">classical</a>,</li>\
		  <li><a href="JavaScript:void(0)">country</a>,</li><br />\
		  <li><a href="JavaScript:void(0)">electronic</a>,</li>\
		  <li><a href="JavaScript:void(0)">emo</a>,</li>\
		  <li><a href="JavaScript:void(0)">folk</a>,</li>\
		  <li><a href="JavaScript:void(0)">hardcore</a>,</li>\
		  <li><a href="JavaScript:void(0)">hip hop</a>,</li>\
		  <li><a href="JavaScript:void(0)">indie</a>,</li>\
		  <li><a href="JavaScript:void(0)">jazz</a>,</li>\
		  <li><a href="JavaScript:void(0)">latin</a>,</li><br />\
		  <li><a href="JavaScript:void(0)">metal</a>,</li>\
		  <li><a href="JavaScript:void(0)">pop</a>,</li>\
		  <li><a href="JavaScript:void(0)">pop punk</a>,</li>\
		  <li><a href="JavaScript:void(0)">punk</a>,</li>\
		  <li><a href="JavaScript:void(0)">reggae</a>,</li>\
		  <li><a href="JavaScript:void(0)">rnb</a>,</li>\
		  <li><a href="JavaScript:void(0)">rock</a>,</li>\
		  <li><a href="JavaScript:void(0)">soul</a>,</li><br />\
		  <li><a href="JavaScript:void(0)">world</a>,</li>\
		  <li><a href="JavaScript:void(0)">60s</a>,</li>\
		  <li><a href="JavaScript:void(0)">70s</a>,</li>\
		  <li><a href="JavaScript:void(0)">80s</a>,</li>\
		  <li><a href="JavaScript:void(0)">90s</a>.</li>\
		</ul>\
	  </div>',
			username: function() {
				...
				var rtrStr = '<div id="username">\
					...
					<ol>';
				for(var i=0; i<15; i++) {
					rtrStr += '<li class="user' + ((i%5)+1) + '"><a href="JavaScript:void(0)" title="' + usernameArray[i].username + '"><img src="' + usernameArray[i].profilePicMedium + '" /><br />' + usernameArray[i].username + '</a></li>';
				}
				return rtrStr;
			}	
		}
...
$(document).ready(function() {
	...
	Museo.PromptModule.loadPlaylist = function(mode, text, restrictLive) {
		...
		Museo.PromptModule.registerHash(mode, text);
    };
	Museo.PromptModule.registerHash = function(mode, text) {
		if(mode == 'tags') {
			var text = text.split(',');
			var i;
			for(i=0; i<text.length; i++) {
				text[i] = text[i].replace(/\s*[^0-9A-Za-z-]\s*/g, '');				
			}
			text = text.join('/');
		}
		mode = (mode == 'username') ? 'user' : mode;
		text = text.replace(/\s+/g, '+');
		location.hash = '#' + mode + '/' + text;		
	};
    ...
    Museo.PlayingModule.onGetPlaylist = function(jsonPlaylist) {
        var to = setTimeout( '\
            ...
            $("#formArea input[type=radio]").unbind();\
			$("#footer").removeAttr("disabled");', 200);
        var i;
		...
		Museo.MainModule.setCurrentState(Museo.constants.PLAYING_STATE);
    };
	...
	function onHashChange(e) {
		...
		if(Museo.MainModule.getCurrentState() != Museo.constants.LOADING_STATE) {
			...
			if(mode == 'artist') {
				...
				url = url.replace(/\+/gi, ' ');
				Museo.PromptModule.loadPlaylist(mode+'name', url, true );
			}
			else if (mode == 'tags') {
				var tags = url.split('/');
				tags = tags.join(', ');
			...
			else if(location.hash == '' && (Museo.MainModule.getCurrentState() != Museo.constants.INITIAL_STATE) )
				location.reload();
		}
	}
	...
	Museo.MainModule.setCurrentState(Museo.constants.PROMPT_STATE);
	// Focus text box
